...
function Straits({ rm, chokes, routes }: { rm: RiskMap; chokes: AssetRow[]; routes: RouteG[] }) {
  ...
  return (
    <>
      <div className="mb-3.5 mt-[26px] flex items-center justify-between gap-2.5"><h2 className="text-[19px] font-extrabold tracking-[-0.02em] text-[#1a2433]">主要海峡のリスクボード</h2><span className={CHIP}>통과 노선 기준 · 지금</span></div>
